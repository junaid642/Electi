...
function saveContact() {
  ...
  a.href = url;
  a.download = "Abdulrhman_Alyemeeni_X360.vcf";
  a.click();
      ...
      <div className="relative z-10 flex flex-col lg:flex-row lg:h-screen">
        ...
        <div className="hidden lg:flex flex-1 flex-col justify-center items-start px-8 sm:px-12 lg:px-16 xl:px-20 py-10 lg:min-h-screen text-start">
          ...
          >
            ...
            >
              Visionary founder redefining Saudi Arabia&apos;s
              <br />
              digital landscape through AI, immersive experiences,
              <br />
        ...
        >
          ...
          <img
            src="/x360/abdulrahman.webp"
            alt="Abdulrhman Alyemeeni — Founder & CEO, X360"
            style={{
              width: "100%",
              height: "100%",
              objectFit: "cover",
