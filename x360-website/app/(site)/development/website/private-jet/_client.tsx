...
const CASE_FAQS = [
  { q: "What digital experiences does X360 create for the luxury and private aviation sector?", qAr: "ما هي التجارب الرقمية التي تنشئها X360 لقطاع الطيران الخاص الفاخر؟", a: "X360 builds ultra-luxury brand websites, private jet charter platforms, bespoke concierge portals, and exclusive membership platforms — combined with cinematic 360° virtual tours of aircraft cabins, private terminals, and luxury lounges for client acquisition and investor presentations.", aAr: "تبني X360 مواقع علامات تجارية فائقة الرفاهية ومنصات تأجير طائرات خاصة وبوابات كونسيرج مخصصة ومنصات عضوية حصرية — مدمجة مع جولات افتراضية سينمائية 360° لأكواخ الطائرات والمحطات الخاصة والصالات الفاخرة لاستقطاب العملاء وعروض المستثمرين." },
  { q: "Can X360 create a 360° virtual tour of a private jet interior?", qAr: "هل تستطيع X360 إنشاء جولة افتراضية 360° لداخل طائرة خاصة؟", a: "Yes. X360 creates ultra-high-resolution 360° virtual tours of private jet cabins, VIP lounges, and private aviation terminals — used by charter operators for client presentations, aircraft listings, and investor documentation.", aAr: "نعم. تنشئ X360 جولات افتراضية 360° عالية الدقة لأكواخ الطائرات الخاصة وصالات VIP ومحطات الطيران الخاص — تُستخدم من قِبل مشغلي الطائرات المستأجرة لعروض العملاء وقوائم الطائرات ووثائق المستثمرين." },
  { q: "What makes an X360 luxury brand website different from a standard web build?", qAr: "ما الذي يجعل موقع العلامة التجارية الفاخر من X360 مختلفاً عن بناء الويب العادي؟", a: "X360 luxury digital platforms match the standard of the brands they represent — cinematic visuals, ultra-smooth animations, bespoke typography, and frictionless Arabic/English bilingual interfaces that feel premium across every device and screen.", aAr: "تتطابق المنصات الرقمية الفاخرة من X360 مع معايير العلامات التجارية التي تمثلها — مرئيات سينمائية وحركات سلسة وطباعة مخصصة وواجهات ثنائية اللغة عربية/إنجليزية سلسة تبدو متميزة على كل جهاز وشاشة." },
  { q: "How does X360 ensure discretion for ultra-high-net-worth clients?", qAr: "كيف تضمن X360 السرية لعملاء ذوي الثروات الفائقة؟", a: "X360 operates under strict NDA for all luxury client work — no public case studies, no project announcements, and no third-party analytics without explicit client consent. Privacy is a premium deliverable, not an afterthought.", aAr: "تعمل X360 بموجب اتفاقية سرية صارمة لجميع أعمال العملاء الفاخرين — لا دراسات حالة عامة ولا إعلانات مشاريع ولا تحليلات خارجية بدون موافقة صريحة من العميل. الخصوصية خدمة مميزة وليست مجرد فكرة." },
  { q: "Which luxury and private aviation clients has X360 worked with?", qAr: "من عملاء الطيران الخاص الفاخر الذين عملت معهم X360؟", a: "X360 has worked with private aviation operators, luxury lifestyle brands, yacht charter companies, and ultra-high-net-worth concierge services across Saudi Arabia and the GCC. All client details are held in strict confidence.", aAr: "عملت X360 مع مشغلي الطيران الخاص وعلامات نمط الحياة الفاخرة وشركات تأجير اليخوت وخدمات الكونسيرج الفاخرة في المملكة العربية السعودية ودول الخليج. جميع تفاصيل العملاء محفوظة بسرية تامة." },
];

export default function PrivateJetClient() {
  const { isAr } = useLang();
  ...
  return (
    <div ref={scrollContainerRef} style={{ height: "100dvh", overflowY: "scroll", scrollSnapType: "y mandatory", scrollBehavior: "smooth", scrollbarWidth: "none" }}>
      ...
      <Snap id="hero" className="flex flex-col items-center justify-center">
        {/* Private Jets & Yachts hero image */}
        {/* eslint-disable-next-line @next/next/no-img-element */}
        <img
          src="/x360/jet-hero.jpg"
          alt=""
          className="absolute inset-0 w-full h-full object-cover pointer-events-none"
          style={{ zIndex: 0, opacity: 1 }}
        />
        <div className="relative flex flex-col items-center text-center gap-7 px-10 py-10"
          style={{ zIndex: 10, maxWidth: 1100 }}>
          <FadeUp delay={0.15}>
            <Badge>{t("Web Development · Private Jets & Yachts", "تطوير المواقع · الطائرات الخاصة واليخوت")}</Badge>
          </FadeUp>
          <FadeUp delay={0.28}>
            <h1 className="font-thin leading-tight tracking-[0.06em] uppercase"
              ...
              {t("Luxury Travel.", "السفر الفاخر.")} <span style={{ color: "#b0b0b0" }}>{t("Digitized.", "رقمناه.")}</span>
            </h1>
          </FadeUp>
          <FadeUp delay={0.42}>
          ...
          <FadeUp delay={0.52}>
            <p className="font-light leading-relaxed" style={{ fontSize: "clamp(0.65rem,1vw,0.78rem)", color: "rgba(255,255,255,1)", maxWidth: 560 }}>
              {t(
                "Ultra-luxury digital ecosystems for private aviation and yacht charter — AI concierge, 360° fleet tours, cinematic booking platforms, and VIP portals.",
                "منظومات رقمية فائقة الفخامة للطيران الخاص وتأجير اليخوت — خدمة كونسيرج بالذكاء الاصطناعي وجولات أسطول 360° ومنصات الحجز السينمائية وبوابات VIP."
              )}
            </p>
          </FadeUp>
        </div>
        ...
        <div className="max-w-5xl w-full mx-auto text-center px-6 relative z-10">
          ...
          <FadeUp delay={0.16}>
            <h2 className="font-thin leading-tight mb-4" style={{ fontSize: "clamp(1.2rem,2.64vw,2.16rem)" }}>
              <AnimatedTextCycle
                words={isAr
                  ? ["شركات الطائرات الخاصة", "الطيران الفاخر", "شركات اليخوت", "خدمات الطائرات المستأجرة", "العلامات الفاخرة", "التجارب البحرية", "سفر VIP"]
                  : ["Private Jet Companies", "Luxury Aviation", "Yacht Companies", "Charter Services", "Ultra Luxury Brands", "Marine Experiences", "VIP Travel"]}
                interval={2000} />
            </h2>
          </FadeUp>
          ...
          <FadeUp delay={0.28}>
            <p className="text-white/30 max-w-lg mx-auto mt-4" style={{ letterSpacing: "0.1em", fontSize: "0.9rem" }}>
              {t("Every journey. Every vessel. One complete ultra-luxury digital ecosystem.", "كل رحلة. كل سفينة. منظومة رقمية فائقة الفخامة واحدة.")}
            </p>
          </FadeUp>
        </div>
      </Snap>
        ...
        <div className="relative z-10 flex flex-col items-center w-full gap-10">
          ...
          <FadeIn delay={0.3} className="relative w-full overflow-hidden marquee-outer">
            ...
            <div dir="ltr" className="inline-flex items-center gap-5 py-2" style={{ animation: "marquee-scroll 44s linear infinite" }}>
              {[
                "/x360/jet-showcase/1.jpg","/x360/jet-showcase/2.jpg","/x360/jet-showcase/3.jpg",
                "/x360/jet-showcase/4.jpg","/x360/jet-showcase/5.jpg","/x360/jet-showcase/6.jpg",
                "/x360/jet-showcase/7.jpg","/x360/jet-showcase/8.jpg",
                "/x360/jet-showcase/1.jpg","/x360/jet-showcase/2.jpg","/x360/jet-showcase/3.jpg",
                "/x360/jet-showcase/4.jpg","/x360/jet-showcase/5.jpg","/x360/jet-showcase/6.jpg",
                "/x360/jet-showcase/7.jpg","/x360/jet-showcase/8.jpg",
              ].map((src, i) => (
          ...
          <FadeUp delay={0.5}>
            <p className="text-[10px] tracking-[0.26em] uppercase" style={{ color: "rgba(255,255,255,0.22)" }}>
              {t("Ultra Luxury · Aviation · Marine · Elite", "فاخر للغاية · طيران · بحري · نخبوي")}
            </p>
          </FadeUp>
        </div>
      </Snap>
          ...
          <div className="max-w-7xl w-full mx-auto relative z-10">
            <FadeUp delay={0.05} className="text-center mb-3 sm:mb-10">
              ...
              <p className="hidden sm:block text-white/35 text-sm mt-4 mx-auto text-center">
                {t("End-to-end digital solutions built specifically for private aviation and luxury marine industries.", "حلول رقمية متكاملة مصممة خصيصاً للطيران الخاص وصناعات البحرية الفاخرة.")}
              </p>
            </FadeUp>
            <div className="grid grid-cols-5 gap-2">
              {[
                { icon: Globe,       en: "Luxury Websites",        ar: "المواقع الفاخرة"                },
                { icon: Smartphone,  en: "Mobile Applications",    ar: "تطبيقات الجوال"                 },
                { icon: Eye,         en: "360° Fleet Tours",       ar: "جولات أسطول 360°"               },
                { icon: Bot,         en: "AI Concierge",           ar: "خدمة كونسيرج الذكاء الاصطناعي" },
                { icon: Star,        en: "VIP Booking Portals",    ar: "بوابات حجز VIP"                 },
        ...
        <div className="relative flex flex-col items-center justify-center w-full h-full overflow-hidden" style={{ background: "#000" }}>
          ...
          <FadeUp delay={0.04} className="relative z-20 text-center mb-8 px-4">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full border border-white/10 text-[11px] font-semibold text-white/45 mb-4"
              style={{ background: "rgba(255,255,255,0.04)" }}>
              <Eye className="w-3 h-3" /> {t("360° Fleet Tours", "جولات أسطول 360°")}
            </div>
            <h2 className="text-2xl sm:text-3xl font-thin">
              {t("Luxury Travel, ", "السفر الفاخر، ")}
            ...
            <div className="relative rounded-2xl overflow-hidden"
              ...
              <div className="flex items-center gap-1.5 px-4 py-2.5" style={{ background: "rgba(255,255,255,0.04)", borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
                ...
                <div className="flex-1 mx-4 px-3 py-0.5 rounded-md text-[10px] font-mono text-white/20 text-center"
                  ...
                  x-360.ai · private-jets-yachts
                </div>
              </div>
              <div className="relative" style={{ height: "55vh", background: "#050505" }}>
                <iframe src={get("dev.private-jet.iframe", "")} title="360° Fleet Tour" className="w-full h-full block border-0" />
                <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 pointer-events-none">
                  ...
                  <p className="text-[10px] tracking-[0.28em] uppercase" style={{ color: "rgba(255,255,255,0.22)" }}>
                    {t("360° Fleet Tour — Coming Soon", "جولة الأسطول 360° — قريباً")}
                  </p>
                </div>
              </div>
            </div>
      ...
      <Snap id="cta" className="flex items-center">
        ...
        <Glow color="56,189,248" x="30%" y="30%" size="50vw" intensity={0.06} />
        ...
        <motion.div className="absolute pointer-events-none rounded-full"
          style={{ width: 300, height: 300, bottom: "-5%", left: "-5%", background: "radial-gradient(circle, rgba(56,189,248,0.06) 0%, transparent 70%)" }}
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center gap-8 w-full h-full px-8">
          ...
          <FadeUp delay={0.15}>
            <h2 className="font-thin uppercase leading-[0.92] tracking-[0.04em]"
              ...
              <span style={{ color: "rgba(255,255,255,0.45)" }}>{t("of Luxury Travel","السفر الفاخر")}</span><br />
              {t("Digitally.","رقمياً.")}
            </h2>
          </FadeUp>
          <FadeUp delay={0.24}>
            <p style={{ fontSize: "clamp(0.88rem,1.5vw,1.05rem)", color: "rgba(255,255,255,0.38)", maxWidth: 540 }}>
              {t("Ultra-luxury digital ecosystems designed for the next generation of private aviation and marine experiences.",
                 "منظومات رقمية فائقة الفخامة مصممة للجيل القادم من تجارب الطيران الخاص والبحرية.")}
            </p>
          </FadeUp>
      ...
      <section style={{ scrollSnapAlign: "start", background: "#000" }}>
        <OtherIndustriesStrip currentSlug="private-jet" />
        <Footer />
      </section>
      <BackButton />
      <WhatsAppButton />
