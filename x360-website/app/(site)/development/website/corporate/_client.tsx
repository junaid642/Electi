...
import {
  ...
  Zap, MessageSquare, Settings, TrendingUp,
  Network, Shield, Layers, Wifi, Cpu,
} from "lucide-react";
...
const CASE_FAQS = [
  { q: "What does a premium corporate website from X360 include?", qAr: "ما الذي يتضمنه موقع الشركات المتميز من X360؟", a: "An X360 corporate website includes a full Arabic/English bilingual site, immersive cinematic design, 360° virtual office or facility tour integration, leadership profiles, investor relations section, media centre, and enterprise-grade SEO built for the Saudi market.", aAr: "يتضمن موقع الشركات من X360 موقعاً ثنائي اللغة عربي/إنجليزي، تصميماً سينمائياً غامراً، تكاملاً لجولات المكاتب أو المرافق الافتراضية 360°، ملفات تعريف القيادة، قسم علاقات المستثمرين، مركزاً إعلامياً وتحسين SEO على مستوى المؤسسات للسوق السعودية." },
  { q: "Can X360 build a corporate website for a Vision 2030 project or government entity?", qAr: "هل تستطيع X360 إنشاء موقع شركة لمشروع رؤية 2030 أو جهة حكومية؟", a: "Yes. X360 has built digital platforms for Vision 2030 project entities and corporate conglomerates. X360 creates platforms that meet KSA corporate communication standards and international investor presentation requirements.", aAr: "نعم. بنت X360 منصات رقمية لكيانات مشاريع رؤية 2030 وتكتلات مؤسسية. تنشئ X360 منصات تلبي معايير الاتصالات المؤسسية في المملكة ومتطلبات عروض المستثمرين الدولية." },
  { q: "How long does a corporate website project take?", qAr: "كم يستغرق مشروع موقع الشركات؟", a: "A standard corporate website is delivered in 3–5 weeks. A full corporate digital ecosystem — including investor portal, careers platform, media centre, and bilingual CMS — is typically 8–12 weeks.", aAr: "يُسلَّم موقع الشركات القياسي في 3-5 أسابيع. المنظومة الرقمية المؤسسية الكاملة — بما في ذلك بوابة المستثمرين ومنصة الوظائف والمركز الإعلامي ونظام إدارة المحتوى ثنائي اللغة — تستغرق عادةً 8-12 أسبوعاً." },
  { q: "Does X360 provide ongoing corporate website management?", qAr: "هل تقدم X360 إدارة مستمرة لمواقع الشركات؟", a: "Yes. X360 offers managed digital services — content management, performance monitoring, security updates, and quarterly design refreshes — ensuring corporate clients maintain a current, high-performing digital presence.", aAr: "نعم. تقدم X360 خدمات رقمية مُدارة — إدارة المحتوى ومراقبة الأداء وتحديثات الأمان وتحديثات التصميم الفصلية — لضمان مواكبة العملاء المؤسسيين لحضور رقمي حالي وعالي الأداء." },
  { q: "Can X360 integrate a 360° virtual office or facility tour into a corporate website?", qAr: "هل تستطيع X360 دمج جولة افتراضية 360° للمكاتب أو المرافق في موقع الشركة؟", a: "Yes. X360 embeds immersive 360° virtual tours of corporate headquarters, manufacturing facilities, and workspaces directly into corporate websites — used for talent acquisition, investor presentations, and partner engagement.", aAr: "نعم. تُدمج X360 جولات افتراضية 360° غامرة لمقرات الشركات ومرافق التصنيع وأماكن العمل مباشرةً في مواقع الشركات — تُستخدم لاستقطاب المواهب وعروض المستثمرين وتفاعل الشركاء." },
];
    ...
    <div ref={scrollContainerRef} style={{ height: "100dvh", overflowY: "scroll", scrollSnapType: "y mandatory", scrollBehavior: "smooth", scrollbarWidth: "none" }}>
      ...
      <Snap id="hero" className="flex flex-col items-center justify-center">
        <video className="hidden sm:block absolute inset-0 w-full h-full object-cover pointer-events-none"
          src={get("corporate.hero-video", "/x360/enterprise-hero.mp4")}
          autoPlay muted loop playsInline
          style={{ zIndex: 0, opacity: 1 }} />
        <video className="sm:hidden absolute inset-0 w-full h-full object-cover pointer-events-none"
          src={get("corporate.mobile-video", "/x360/enterprise-hero.mp4")}
          autoPlay muted loop playsInline
          style={{ zIndex: 0, opacity: 1 }} />
        <div className="relative flex flex-col items-center text-center gap-7 px-10 py-10 rounded-2xl"
          ...
          <FadeUp delay={0.15}>
            <Badge>{t("Web Development · Enterprise", "تطوير المواقع · المؤسسات")}</Badge>
          </FadeUp>
          <FadeUp delay={0.28}>
            <h1 className="font-thin leading-tight tracking-[0.06em] uppercase"
              ...
              {t("Enterprise.", "المؤسسات.")} <span style={{ color: "#b0b0b0" }}>{t("Reimagined.", "أُعيد تصوّرها.")}</span>
            </h1>
          </FadeUp>
          <FadeUp delay={0.42}>
          ...
          <FadeUp delay={0.52}>
            <p className="font-light leading-relaxed" style={{ fontSize: "clamp(0.65rem,1vw,0.78rem)", color: "rgba(255,255,255,1)", maxWidth: 560 }}>
              {t(
                "Intelligent enterprise ecosystems powered by ERP integrations, AI systems, analytics dashboards, cybersecurity, and connected cloud infrastructure.",
                "منظومات مؤسسية ذكية مدعومة بتكاملات ERP وأنظمة الذكاء الاصطناعي ولوحات التحليلات والأمن السيبراني والبنية التحتية السحابية."
              )}
            </p>
          </FadeUp>
        </div>
        ...
        <div className="max-w-5xl w-full mx-auto text-center px-6 relative z-10">
          ...
          <FadeUp delay={0.16}>
            <h2 className="font-thin leading-tight mb-4" style={{ fontSize: "clamp(1.2rem,2.64vw,2.16rem)" }}>
              <AnimatedTextCycle
                words={isAr
                  ? ["الشركات المؤسسية", "الشركات الصناعية", "مؤسسات البناء", "الشركات الهندسية", "شركات البنية التحتية", "مشاريع المدن الذكية", "المنظمات الكبرى"]
                  : ["Corporate Companies", "Industrial Firms", "Construction Enterprises", "Engineering Firms", "Infrastructure Companies", "Smart City Projects", "Large Organizations"]}
                interval={2000} />
            </h2>
          </FadeUp>
          ...
          <FadeUp delay={0.28}>
            <p className="text-white/30 max-w-lg mx-auto mt-4" style={{ letterSpacing: "0.1em", fontSize: "0.9rem" }}>
              {t("Every sector. Every scale. One complete digital ecosystem.", "كل قطاع. كل نطاق. منظومة رقمية متكاملة واحدة.")}
            </p>
          </FadeUp>
        </div>
      </Snap>
      ...
      <Snap id="showcase" className="flex flex-col items-center justify-center">
        ...
        <div className="relative z-10 flex flex-col items-center w-full gap-10">
          ...
          <FadeIn delay={0.3} className="relative w-full overflow-hidden marquee-outer">
            ...
            <div dir="ltr" className="inline-flex items-center gap-5 py-2" style={{ animation: "marquee-scroll 56s linear infinite" }}>
              {[
                "/x360/enterprise-showcase/1.gif", "/x360/enterprise-showcase/2.jpg",  "/x360/enterprise-showcase/3.webp",
                "/x360/enterprise-showcase/4.jpg",  "/x360/enterprise-showcase/5.jpg",  "/x360/enterprise-showcase/6.jpg",
                "/x360/enterprise-showcase/7.jpg",  "/x360/enterprise-showcase/8.jpg",  "/x360/enterprise-showcase/9.jpg",
                "/x360/enterprise-showcase/10.jpg", "/x360/enterprise-showcase/11.jpg", "/x360/enterprise-showcase/12.jpg",
                "/x360/enterprise-showcase/1.gif", "/x360/enterprise-showcase/2.jpg",  "/x360/enterprise-showcase/3.webp",
                "/x360/enterprise-showcase/4.jpg",  "/x360/enterprise-showcase/5.jpg",  "/x360/enterprise-showcase/6.jpg",
                "/x360/enterprise-showcase/7.jpg",  "/x360/enterprise-showcase/8.jpg",  "/x360/enterprise-showcase/9.jpg",
                "/x360/enterprise-showcase/10.jpg", "/x360/enterprise-showcase/11.jpg", "/x360/enterprise-showcase/12.jpg",
          ...
          <FadeUp delay={0.5}>
            <p className="text-[10px] tracking-[0.26em] uppercase" style={{ color: "rgba(255,255,255,0.22)" }}>
              {t("Corporate · Industrial · Infrastructure · Smart", "مؤسسي · صناعي · بنية تحتية · ذكي")}
            </p>
          </FadeUp>
        </div>
      </Snap>
          ...
          <div className="max-w-7xl w-full mx-auto relative z-10">
            <FadeUp delay={0.05} className="text-center mb-3 sm:mb-10">
              ...
              <p className="hidden sm:block text-white/35 text-sm mt-4 mx-auto text-center">
                {t("End-to-end digital solutions built specifically for enterprise organizations.", "حلول رقمية متكاملة مصممة خصيصاً للمنظمات المؤسسية.")}
              </p>
            </FadeUp>
            <div className="grid grid-cols-5 gap-2">
              {[
                ...
                { icon: Database,    en: "ERP / SAP Integrations", ar: "تكاملات ERP و SAP"              },
                { icon: BarChart3,   en: "Analytics Dashboards",   ar: "لوحات التحليلات"                },
                { icon: Network,     en: "Cloud Systems",          ar: "الأنظمة السحابية"               },
        ...
        <div className="relative flex flex-col items-center justify-center w-full h-full overflow-hidden" style={{ background: "#000" }}>
          ...
          <FadeUp delay={0.04} className="relative z-20 text-center mb-8 px-4">
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full border border-white/10 text-[11px] font-semibold text-white/45 mb-4"
              style={{ background: "rgba(255,255,255,0.04)" }}>
              <BarChart3 className="w-3 h-3" /> {t("Enterprise Dashboards", "لوحات المؤسسات")}
            </div>
          ...
          <FadeIn delay={0.14} className="relative z-20 w-full max-w-4xl mx-auto px-4 sm:px-6">
            <div className="relative rounded-2xl overflow-hidden"
              ...
              <div className="relative" style={{ height: "55vh", background: "#050505" }}>
                {/* iframe — update src when enterprise demo URL is available */}
                <iframe src={get("dev.corporate.iframe", "")} title="Enterprise Dashboard" className="w-full h-full block border-0" />
                <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 pointer-events-none">
                  <motion.div className="w-14 h-14 rounded-full flex items-center justify-center"
                    ...
                    <BarChart3 style={{ width: 22, height: 22, color: ACCENT }} />
                  </motion.div>
                  <p className="text-[10px] tracking-[0.28em] uppercase" style={{ color: "rgba(255,255,255,0.22)" }}>
                    {t("Enterprise Dashboard — Coming Soon", "لوحة المؤسسات — قريباً")}
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center gap-8 w-full h-full px-8">
          ...
          <FadeUp delay={0.15}>
            <h2 className="font-thin uppercase leading-[0.92] tracking-[0.04em]"
              ...
              <span style={{ color: "rgba(255,255,255,0.45)" }}>{t("of Enterprise","المؤسسات")}</span><br />
              {t("Digitally.","رقمياً.")}
            </h2>
          </FadeUp>
          <FadeUp delay={0.24}>
            <p style={{ fontSize: "clamp(0.88rem,1.5vw,1.05rem)", color: "rgba(255,255,255,0.38)", maxWidth: 540 }}>
              {t("Intelligent digital ecosystems designed for the next generation of enterprise operations.",
                 "منظومات رقمية ذكية مصممة للجيل القادم من العمليات المؤسسية.")}
            </p>
          </FadeUp>
      ...
      <section style={{ scrollSnapAlign: "start", background: "#000" }}>
        <OtherIndustriesStrip currentSlug="corporate" />
        <Footer />
      </section>
      <BackButton />
      <WhatsAppButton />
