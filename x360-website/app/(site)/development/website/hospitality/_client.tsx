...
import {
  ...
  Cpu, Network, Shield, Layers, Wifi, Star,
} from "lucide-react";
...
const CASE_FAQS = [
  { q: "What digital platforms does X360 build for Saudi hotels and restaurants?", qAr: "ما المنصات الرقمية التي تبنيها X360 للفنادق والمطاعم السعودية؟", a: "X360 builds hotel websites, direct booking engines, F&B brand sites, loyalty program platforms, and event booking portals — all bilingual Arabic/English and optimised for Saudi and GCC travellers with local payment gateway integration.", aAr: "تبني X360 مواقع فنادق ومحركات حجز مباشر ومواقع علامات F&B ومنصات برامج الولاء وبوابات حجز الفعاليات — جميعها ثنائية اللغة عربي/إنجليزي ومُحسَّنة للمسافرين السعوديين وعملاء دول الخليج مع تكامل بوابات الدفع المحلية." },
  { q: "Can X360 build hotel websites that drive direct bookings?", qAr: "هل تستطيع X360 إنشاء مواقع فندقية تدفع الحجوزات المباشرة؟", a: "Yes. X360 builds hotel websites with integrated direct booking engines — including Arabic/English interfaces, Saudi payment gateway integration, and seamless channel manager connectivity. Direct booking conversion is a core design priority on every hospitality project.", aAr: "نعم. تبني X360 مواقع فندقية مع محركات حجز مباشر مدمجة — تتضمن واجهات عربي/إنجليزي وتكامل بوابات الدفع السعودية واتصالاً سلساً بمدير القنوات. تحويل الحجز المباشر هو أولوية تصميمية أساسية في كل مشروع ضيافة." },
  { q: "How do virtual tours increase hospitality revenue?", qAr: "كيف تزيد الجولات الافتراضية من إيرادات قطاع الضيافة؟", a: "Guests who view a virtual tour are 5× more likely to book than those viewing photos only. X360 embeds 360° tours of rooms, dining areas, and event spaces directly into hotel websites — showing guests exactly what they're booking before they commit.", aAr: "الضيوف الذين يشاهدون جولة افتراضية أكثر ميلاً للحجز بـ5 مرات مقارنة بمن يشاهدون الصور فقط. تُدمج X360 جولات 360° للغرف ومناطق تناول الطعام وأماكن الفعاليات مباشرةً في مواقع الفنادق — تُري الضيوف بالضبط ما يحجزونه قبل الالتزام." },
  { q: "Which hospitality brands has X360 worked with in Saudi Arabia?", qAr: "مع أي علامات ضيافة عملت X360 في المملكة العربية السعودية؟", a: "X360 has worked with boutique hotels, resort properties, F&B groups, and hospitality management companies across Saudi Arabia and the GCC. Project references are available under NDA.", aAr: "عملت X360 مع فنادق بوتيك ومنتجعات ومجموعات F&B وشركات إدارة الضيافة في المملكة العربية السعودية ودول الخليج. مراجع المشاريع متاحة بموجب اتفاقية سرية." },
  { q: "Can X360 build a food and beverage brand website?", qAr: "هل تستطيع X360 إنشاء موقع علامة تجارية للأغذية والمشروبات؟", a: "Yes. X360 builds F&B brand websites with online reservations, visual menus, virtual restaurant tours, and bilingual Arabic/English content — designed to convert social media visitors into in-restaurant guests.", aAr: "نعم. تبني X360 مواقع علامات F&B مع حجوزات أونلاين وقوائم بصرية وجولات افتراضية للمطاعم ومحتوى ثنائي اللغة عربي/إنجليزي — مصممة لتحويل زوار وسائل التواصل الاجتماعي إلى ضيوف في المطعم." },
];
    ...
    <div ref={scrollContainerRef} style={{ height: "100dvh", overflowY: "scroll", scrollSnapType: "y mandatory", scrollBehavior: "smooth", scrollbarWidth: "none" }}>
      ...
      <Snap id="hero" className="flex flex-col items-center justify-center">
        <video className="hidden sm:block absolute inset-0 w-full h-full object-cover pointer-events-none"
          src={get("hospitality.hero-video", "/x360/hospitality-hero.mp4")}
          autoPlay muted loop playsInline
          style={{ zIndex: 0, opacity: 1 }} />
        <video className="sm:hidden absolute inset-0 w-full h-full object-cover pointer-events-none"
          src={get("hospitality.mobile-video", "/x360/hospitality-hero.mp4")}
          autoPlay muted loop playsInline
          style={{ zIndex: 0, opacity: 1 }} />
        <div className="relative flex flex-col items-center text-center gap-7 px-10 py-10 rounded-2xl"
          ...
          <FadeUp delay={0.15}>
            <Badge>{t("Web Development · Hospitality", "تطوير المواقع · الضيافة")}</Badge>
          </FadeUp>
          <FadeUp delay={0.28}>
            <h1 className="font-thin leading-tight tracking-[0.06em] uppercase"
              ...
              {t("Hospitality.", "الضيافة.")} <span style={{ color: "#b0b0b0" }}>{t("Elevated.", "مُرتقت.")}</span>
            </h1>
          </FadeUp>
          <FadeUp delay={0.42}>
          ...
          <FadeUp delay={0.52}>
            <p className="font-light leading-relaxed" style={{ fontSize: "clamp(0.65rem,1vw,0.78rem)", color: "rgba(255,255,255,1)", maxWidth: 560 }}>
              {t(
                "Immersive hospitality ecosystems powered by AI booking, 360° experiences, digital menus, and luxury technology design.",
                "منظومات ضيافة غامرة مدعومة بالحجز الذكي وتجارب 360° والقوائم الرقمية وتصميم التقنية الفاخرة."
              )}
            </p>
          </FadeUp>
        </div>
        ...
        <div className="max-w-5xl w-full mx-auto text-center px-6 relative z-10">
          ...
          <FadeUp delay={0.16}>
            <h2 className="font-thin leading-tight mb-4" style={{ fontSize: "clamp(1.2rem,2.64vw,2.16rem)" }}>
              <AnimatedTextCycle
                words={isAr
                  ? ["الفنادق", "المنتجعات", "المطاعم", "المقاهي", "المطاعم الفاخرة", "التجارب السياحية", "الضيافة الفاخرة"]
                  : ["Hotels", "Resorts", "Restaurants", "Cafes", "Fine Dining", "Tourism Experiences", "Luxury Hospitality"]}
                interval={2000} />
            </h2>
          </FadeUp>
          ...
          <FadeUp delay={0.28}>
            <p className="text-white/30 max-w-lg mx-auto mt-4" style={{ letterSpacing: "0.1em", fontSize: "0.9rem" }}>
              {t("Every guest. Every scale. One complete digital ecosystem.", "كل ضيف. كل نطاق. منظومة رقمية متكاملة واحدة.")}
            </p>
          </FadeUp>
        </div>
      </Snap>
      ...
      <Snap id="showcase" className="flex flex-col items-center justify-center">
        ...
        <div className="relative z-10 flex flex-col items-center w-full gap-10">
          ...
          <FadeIn delay={0.3} className="relative w-full overflow-hidden marquee-outer">
            ...
            <div dir="ltr" className="inline-flex items-center gap-5 py-2" style={{ animation: "marquee-scroll 60s linear infinite" }}>
              {[
                "/x360/hospitality-showcase/1.jpg",  "/x360/hospitality-showcase/2.png",  "/x360/hospitality-showcase/3.jpg",
                "/x360/hospitality-showcase/4.jpg",  "/x360/hospitality-showcase/5.jpg",  "/x360/hospitality-showcase/6.jpg",
                "/x360/hospitality-showcase/7.jpg",  "/x360/hospitality-showcase/8.jpg",  "/x360/hospitality-showcase/9.jpg",
                "/x360/hospitality-showcase/10.jpg", "/x360/hospitality-showcase/11.jpg", "/x360/hospitality-showcase/12.jpg",
                "/x360/hospitality-showcase/1.jpg",  "/x360/hospitality-showcase/2.png",  "/x360/hospitality-showcase/3.jpg",
                "/x360/hospitality-showcase/4.jpg",  "/x360/hospitality-showcase/5.jpg",  "/x360/hospitality-showcase/6.jpg",
                "/x360/hospitality-showcase/7.jpg",  "/x360/hospitality-showcase/8.jpg",  "/x360/hospitality-showcase/9.jpg",
                "/x360/hospitality-showcase/10.jpg", "/x360/hospitality-showcase/11.jpg", "/x360/hospitality-showcase/12.jpg",
          ...
          <FadeUp delay={0.5}>
            <p className="text-[10px] tracking-[0.26em] uppercase" style={{ color: "rgba(255,255,255,0.22)" }}>
              {t("Luxury · Hotels · Restaurants · Resorts", "فاخر · فنادق · مطاعم · منتجعات")}
            </p>
          </FadeUp>
        </div>
      </Snap>
          ...
          <div className="max-w-7xl w-full mx-auto relative z-10">
            <FadeUp delay={0.05} className="text-center mb-3 sm:mb-10">
              ...
              <p className="hidden sm:block text-white/35 text-sm mt-4 mx-auto text-center">
                {t("End-to-end digital solutions built specifically for the hospitality industry.", "حلول رقمية متكاملة مصممة خصيصاً لقطاع الضيافة.")}
              </p>
            </FadeUp>
            ...
            <div className="relative rounded-2xl overflow-hidden"
              ...
              <div className="flex items-center gap-1.5 px-4 py-2.5" style={{ background: "rgba(255,255,255,0.04)", borderBottom: "1px solid rgba(255,255,255,0.06)" }}>
                ...
                <div className="flex-1 mx-4 px-3 py-0.5 rounded-md text-[10px] font-mono text-white/20 text-center"
                  ...
                  x-360.ai · hospitality
                </div>
              </div>
              <div className="relative" style={{ height: "55vh", background: "#050505" }}>
                {/* iframe — update src when 360° tour URL is available */}
                <iframe src={get("dev.hospitality.iframe", "")} title="Hospitality 360° Tour" className="w-full h-full block border-0" />
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center gap-8 w-full h-full px-8">
          ...
          <FadeUp delay={0.15}>
            <h2 className="font-thin uppercase leading-[0.92] tracking-[0.04em]"
              ...
              <span style={{ color: "rgba(255,255,255,0.45)" }}>{t("of Hospitality","الضيافة")}</span><br />
              {t("Digitally.","رقمياً.")}
            </h2>
          </FadeUp>
          <FadeUp delay={0.24}>
            <p style={{ fontSize: "clamp(0.88rem,1.5vw,1.05rem)", color: "rgba(255,255,255,0.38)", maxWidth: 540 }}>
              {t("Luxury digital ecosystems designed for the next generation of hospitality experiences.",
                 "منظومات رقمية فاخرة مصممة للجيل القادم من تجارب الضيافة.")}
            </p>
          </FadeUp>
      ...
      <section style={{ scrollSnapAlign: "start", background: "#000" }}>
        <OtherIndustriesStrip currentSlug="hospitality" />
        <Footer />
      </section>
      <BackButton />
      <WhatsAppButton />
