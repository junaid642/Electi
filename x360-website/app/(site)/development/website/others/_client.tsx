...
const CASE_FAQS = [
  { q: "Does X360 work with industries beyond hospitality, real estate, and healthcare?", qAr: "هل تعمل X360 مع قطاعات تتجاوز الضيافة والعقارات والرعاية الصحية؟", a: "Yes. X360 works with businesses across all sectors — including construction, manufacturing, education, government, non-profit, and professional services. X360 has delivered digital solutions for clients in every major Saudi industry vertical.", aAr: "نعم. تعمل X360 مع شركات في جميع القطاعات — بما في ذلك البناء والتصنيع والتعليم والحكومة والمنظمات غير الربحية والخدمات المهنية. قدمت X360 حلولاً رقمية لعملاء في جميع القطاعات الصناعية السعودية الرئيسية." },
  { q: "Can X360 build a custom digital platform for a niche Saudi business?", qAr: "هل تستطيع X360 إنشاء منصة رقمية مخصصة لعمل سعودي متخصص؟", a: "Yes. X360 specialises in bespoke digital solutions — custom-designed from scratch for the specific brand, audience, and business model. X360 does not use off-the-shelf templates for client projects.", aAr: "نعم. تتخصص X360 في الحلول الرقمية المخصصة — مصممة من الصفر للعلامة التجارية والجمهور ونموذج العمل المحدد. لا تستخدم X360 قوالب جاهزة لمشاريع العملاء." },
  { q: "How does X360 approach projects in unfamiliar sectors?", qAr: "كيف تتعامل X360 مع المشاريع في قطاعات غير مألوفة؟", a: "Every X360 project begins with a discovery phase — understanding the client's sector, competitors, audience, and digital objectives before designing a single element. This ensures the solution is built for the specific business context, not adapted from a generic template.", aAr: "يبدأ كل مشروع في X360 بمرحلة اكتشاف — فهم قطاع العميل والمنافسين والجمهور والأهداف الرقمية قبل تصميم أي عنصر. هذا يضمن بناء الحل للسياق التجاري المحدد، لا تكييفه من قالب عام." },
  { q: "What is X360's typical process for a new industry client?", qAr: "ما هو الإجراء النموذجي لـ X360 مع عميل من قطاع جديد؟", a: "X360 follows four phases: Discovery → Design → Build → Launch. Clients receive weekly progress updates throughout, and X360 uses phased delivery so results are visible early. All projects include bilingual Arabic/English delivery and Saudi market SEO.", aAr: "تتبع X360 أربع مراحل: الاكتشاف → التصميم → البناء → الإطلاق. يتلقى العملاء تحديثات أسبوعية طوال فترة التنفيذ، وتستخدم X360 التسليم المرحلي حتى تكون النتائج مرئية مبكراً. جميع المشاريع تتضمن التسليم ثنائي اللغة وSEO السوق السعودية." },
  { q: "Can X360 integrate 360° virtual tours into any industry website?", qAr: "هل تستطيع X360 دمج جولات افتراضية 360° في موقع أي قطاع؟", a: "Yes. X360 embeds immersive 360° virtual tours into websites across any sector — from construction site progress tours for investor updates, to school campus tours for student recruitment, to industrial facility tours for partner onboarding.", aAr: "نعم. تُدمج X360 جولات افتراضية 360° غامرة في مواقع أي قطاع — من جولات تقدم موقع البناء لتحديثات المستثمرين، إلى جولات حرم المدرسة لاستقطاب الطلاب، إلى جولات المرافق الصناعية لتأهيل الشركاء." },
];
  ...
  return (
    <div ref={scrollContainerRef} style={{ height: "100dvh", overflowY: "scroll", scrollSnapType: "y mandatory", scrollBehavior: "smooth", scrollbarWidth: "none" }}>
          ...
          <FadeIn delay={0.14} className="relative z-20 w-full max-w-4xl mx-auto px-4 sm:px-6">
            <div className="relative rounded-2xl overflow-hidden"
              ...
              <div className="relative" style={{ height: "55vh", background: "#050505" }}>
                {/* iframe — update src when 360° fleet tour URL is available */}
                <iframe src={get("dev.others.iframe", "")} title="360° Fleet Tour" className="w-full h-full block border-0" />
      ...
      <section style={{ scrollSnapAlign: "start", background: "#000" }}>
        <OtherIndustriesStrip currentSlug="others" />
        <Footer />
      </section>
      <BackButton />
      <WhatsAppButton />
