...
import {
  ...
  Shield, Layers, Wifi, Cpu, Activity,
} from "lucide-react";
...
const CASE_FAQS = [
  { q: "What healthcare digital platforms has X360 built in Saudi Arabia?", qAr: "ما المنصات الرقمية الصحية التي بنتها X360 في المملكة العربية السعودية؟", a: "X360 has built websites and digital platforms for hospitals, clinics, medical cities, pharmaceutical companies, and healthcare groups across Saudi Arabia — including patient portals, doctor booking systems, lab result platforms, and telehealth interfaces. All platforms are bilingual Arabic/English and designed to meet Saudi MOH digital guidelines.", aAr: "بنت X360 مواقع ومنصات رقمية للمستشفيات والعيادات والمدن الطبية وشركات الأدوية والمجموعات الصحية في المملكة العربية السعودية — تشمل بوابات المرضى وأنظمة حجز الأطباء ومنصات نتائج المختبرات وواجهات الرعاية الصحية عن بُعد. جميعها ثنائية اللغة ومصممة وفق إرشادات وزارة الصحة الرقمية." },
  { q: "Can X360 integrate 360° virtual tours into hospital websites?", qAr: "هل تستطيع X360 دمج جولات افتراضية 360° في مواقع المستشفيات؟", a: "Yes. X360 combines its virtual tour expertise with web development — embedding immersive 360° facility tours directly into hospital websites. This helps with patient orientation before admission, international specialist recruitment, JCI accreditation presentations, and investor reviews.", aAr: "نعم. تجمع X360 خبرتها في الجولات الافتراضية مع تطوير الويب — تُدمج جولات المرافق الغامرة 360° مباشرةً في مواقع المستشفيات. هذا يساعد في توجيه المرضى قبل الدخول واستقطاب المتخصصين الدوليين وعروض اعتماد JCI ومراجعات المستثمرين." },
  { q: "How does X360 ensure data privacy for healthcare platforms?", qAr: "كيف تضمن X360 خصوصية البيانات للمنصات الصحية؟", a: "All X360 healthcare digital platforms are built with PDPL (Saudi Personal Data Protection Law) compliance in mind — including encrypted data transmission, role-based access control, audit logging, and no storage of identifiable patient data without explicit consent.", aAr: "جميع منصات X360 الرقمية الصحية مبنية مع مراعاة الامتثال لنظام حماية البيانات الشخصية (PDPL) السعودي — بما يشمل تشفير نقل البيانات والتحكم في الوصول القائم على الأدوار وتسجيل التدقيق وعدم تخزين بيانات المرضى دون موافقة صريحة." },
  { q: "What makes X360 healthcare websites different from generic web agencies?", qAr: "ما الذي يميز مواقع X360 الصحية عن وكالات الويب العامة؟", a: "X360 is built specifically for the Saudi market and understands healthcare-specific requirements — MOH digital guidelines, bilingual clinical terminology, and integration with Saudi health IT ecosystems.", aAr: "X360 مبنية خصيصاً للسوق السعودية وتفهم المتطلبات الخاصة بالقطاع الصحي — إرشادات وزارة الصحة الرقمية والمصطلحات السريرية ثنائية اللغة والتكامل مع أنظمة تقنية المعلومات الصحية السعودية." },
  { q: "How quickly can X360 deliver a healthcare website?", qAr: "ما مدى سرعة تسليم X360 لموقع رعاية صحية؟", a: "A standard healthcare provider website is delivered in 3–4 weeks. A full patient portal or digital health platform is 6–12 weeks depending on integrations. X360 offers phased delivery so the public-facing site goes live first while backend systems are completed.", aAr: "يُسلَّم الموقع القياسي لمزود الرعاية الصحية في 3-4 أسابيع. منصة بوابة المريض أو الصحة الرقمية الكاملة تستغرق 6-12 أسبوعاً حسب التكاملات. تقدم X360 تسليماً مرحلياً حتى يعمل الموقع العام أولاً بينما تكتمل أنظمة الخلفية." },
];
    ...
    <div ref={scrollContainerRef} style={{ height: "100dvh", overflowY: "scroll", scrollSnapType: "y mandatory", scrollBehavior: "smooth", scrollbarWidth: "none" }}>
      ...
      <Snap id="hero" className="flex flex-col items-center justify-center">
        <video className="hidden sm:block absolute inset-0 w-full h-full object-cover pointer-events-none"
          src={get("healthcare.hero-video", "/x360/healthcare-hero.mp4")}
          autoPlay muted loop playsInline
          style={{ zIndex: 0, opacity: 1 }} />
        <video className="sm:hidden absolute inset-0 w-full h-full object-cover pointer-events-none"
          src={get("healthcare.mobile-video", "/x360/healthcare-hero.mp4")}
          autoPlay muted loop playsInline
          style={{ zIndex: 0, opacity: 1 }} />
        <div className="relative flex flex-col items-center text-center gap-7 px-10 py-10 rounded-2xl"
          ...
          <FadeUp delay={0.15}>
            <Badge>{t("Web Development · Healthcare", "تطوير المواقع · الرعاية الصحية")}</Badge>
          </FadeUp>
          <FadeUp delay={0.28}>
            <h1 className="font-thin leading-tight tracking-[0.06em] uppercase"
              ...
              {t("Healthcare.", "الرعاية الصحية.")} <span style={{ color: "#b0b0b0" }}>{t("Elevated.", "مُرتقت.")}</span>
            </h1>
          </FadeUp>
          <FadeUp delay={0.42}>
          ...
          <FadeUp delay={0.52}>
            <p className="font-light leading-relaxed" style={{ fontSize: "clamp(0.65rem,1vw,0.78rem)", color: "rgba(255,255,255,1)", maxWidth: 560 }}>
              {t(
                "Modern healthcare digital experiences — appointment booking, patient portals, AI health assistants, and HIPAA-compliant infrastructure.",
                "تجارب رقمية صحية حديثة — حجز مواعيد وبوابات مرضى ومساعدون صحيون بالذكاء الاصطناعي وبنية تحتية متوافقة مع HIPAA."
              )}
            </p>
          </FadeUp>
        </div>
        ...
        <div className="max-w-5xl w-full mx-auto text-center px-6 relative z-10">
          ...
          <FadeUp delay={0.16}>
            <h2 className="font-thin leading-tight mb-4" style={{ fontSize: "clamp(1.2rem,2.64vw,2.16rem)" }}>
              <AnimatedTextCycle
                words={isAr
                  ? ["المستشفيات", "العيادات", "المراكز الطبية", "عيادات الأسنان", "الصيدليات", "مختبرات التشخيص", "مراكز العافية"]
                  : ["Hospitals", "Clinics", "Medical Centres", "Dental Clinics", "Pharmacies", "Diagnostic Labs", "Wellness Centres"]}
                interval={2000} />
            </h2>
          </FadeUp>
          ...
          <FadeUp delay={0.28}>
            <p className="text-white/30 max-w-lg mx-auto mt-4" style={{ letterSpacing: "0.1em", fontSize: "0.9rem" }}>
              {t("Every patient. Every scale. One complete digital ecosystem.", "كل مريض. كل نطاق. منظومة رقمية متكاملة واحدة.")}
            </p>
          </FadeUp>
        </div>
      </Snap>
      ...
      <Snap id="showcase" className="flex flex-col items-center justify-center">
        ...
        <div className="relative z-10 flex flex-col items-center w-full gap-10">
          ...
          <FadeIn delay={0.3} className="relative w-full overflow-hidden marquee-outer">
            ...
            <div dir="ltr" className="inline-flex items-center gap-5 py-2" style={{ animation: "marquee-scroll 50s linear infinite" }}>
              {[
                "/x360/healthcare-showcase/1.jpg", "/x360/healthcare-showcase/2.jpg", "/x360/healthcare-showcase/3.jpg",
                "/x360/healthcare-showcase/4.jpg", "/x360/healthcare-showcase/5.jpg", "/x360/healthcare-showcase/6.jpg",
                "/x360/healthcare-showcase/7.jpg", "/x360/healthcare-showcase/8.jpg", "/x360/healthcare-showcase/9.jpg",
                "/x360/healthcare-showcase/1.jpg", "/x360/healthcare-showcase/2.jpg", "/x360/healthcare-showcase/3.jpg",
                "/x360/healthcare-showcase/4.jpg", "/x360/healthcare-showcase/5.jpg", "/x360/healthcare-showcase/6.jpg",
                "/x360/healthcare-showcase/7.jpg", "/x360/healthcare-showcase/8.jpg", "/x360/healthcare-showcase/9.jpg",
              ].map((src, i) => (
          ...
          <FadeUp delay={0.5}>
            <p className="text-[10px] tracking-[0.26em] uppercase" style={{ color: "rgba(255,255,255,0.22)" }}>
              {t("Clinics · Hospitals · Medical Centres · Wellness", "عيادات · مستشفيات · مراكز طبية · صحة")}
            </p>
          </FadeUp>
        </div>
      </Snap>
          ...
          <div className="max-w-7xl w-full mx-auto relative z-10">
            <FadeUp delay={0.05} className="text-center mb-3 sm:mb-10">
              ...
              <p className="hidden sm:block text-white/35 text-sm mt-4 mx-auto text-center">
                {t("End-to-end digital solutions built specifically for the healthcare industry.", "حلول رقمية متكاملة مصممة خصيصاً لقطاع الرعاية الصحية.")}
              </p>
            </FadeUp>
            <div className="grid grid-cols-5 gap-2">
              {[
                ...
                { icon: Bot,         en: "AI Health Assistants",  ar: "مساعدون صحيون بالذكاء"         },
                { icon: Activity,    en: "Patient Portals",       ar: "بوابات المرضى"                 },
                { icon: Layers,      en: "Appointment Systems",   ar: "أنظمة حجز المواعيد"            },
                { icon: Cpu,         en: "Medical AI / Analytics",ar: "تحليلات طبية بالذكاء"          },
                { icon: TrendingUp,  en: "SEO Optimization",      ar: "تحسين محركات البحث"            },
                { icon: Wifi,        en: "Hosting",               ar: "الاستضافة"                     },
                { icon: Shield,      en: "HIPAA Compliance",      ar: "الامتثال لـ HIPAA"             },
              ].map((svc, i) => {
                const Icon = svc.icon;
                return (
          ...
          <FadeIn delay={0.14} className="relative z-20 w-full max-w-4xl mx-auto px-4 sm:px-6">
            <div className="relative rounded-2xl overflow-hidden"
              ...
              <div className="relative" style={{ height: "55vh", background: "#050505" }}>
                <iframe src={get("dev.healthcare.iframe", "")} title="Healthcare 360° Tour" className="w-full h-full block border-0" />
                <div className="absolute inset-0 flex flex-col items-center justify-center gap-3 pointer-events-none">
                  <motion.div className="w-14 h-14 rounded-full flex items-center justify-center"
                    ...
                    <Eye style={{ width: 22, height: 22, color: ACCENT }} />
                  </motion.div>
                  <p className="text-[10px] tracking-[0.28em] uppercase" style={{ color: "rgba(255,255,255,0.22)" }}>
                    {t("360° Experience — Coming Soon", "تجربة 360° — قريباً")}
                  </p>
                </div>
              </div>
            </div>
      ...
      <Snap id="clients" className="flex flex-col items-center justify-center">
        <div className="relative flex flex-col items-center justify-center w-full h-full">
          ...
          <div className="flex flex-col items-center text-center gap-8 w-full relative z-10">
            <FadeUp delay={0}>
              <Badge>{t("Kingdom of Saudi Arabia", "المملكة العربية السعودية")}</Badge>
            </FadeUp>
            <FadeUp delay={0.1}>
      ...
      <Snap id="cta" className="flex items-center">
        ...
        <Glow color="52,211,153" x="30%" y="30%" size="50vw" intensity={0.06} />
        ...
        <motion.div className="absolute pointer-events-none rounded-full"
          style={{ width: 300, height: 300, bottom: "-5%", left: "-5%", background: "radial-gradient(circle, rgba(52,211,153,0.06) 0%, transparent 70%)" }}
        ...
        <div className="relative z-10 flex flex-col items-center justify-center text-center gap-8 w-full h-full px-8">
          ...
          <FadeUp delay={0.15}>
            <h2 className="font-thin uppercase leading-[0.92] tracking-[0.04em]"
              ...
              <span style={{ color: "rgba(255,255,255,0.45)" }}>{t("of Healthcare","الرعاية الصحية")}</span><br />
              {t("Digitally.","رقمياً.")}
            </h2>
          </FadeUp>
          <FadeUp delay={0.24}>
            <p style={{ fontSize: "clamp(0.88rem,1.5vw,1.05rem)", color: "rgba(255,255,255,0.38)", maxWidth: 540 }}>
              {t("Cutting-edge digital ecosystems designed for the next generation of healthcare providers.",
                 "منظومات رقمية متطورة مصممة للجيل القادم من مزودي الرعاية الصحية.")}
            </p>
          </FadeUp>
      ...
      <section style={{ scrollSnapAlign: "start", background: "#000" }}>
        <OtherIndustriesStrip currentSlug="healthcare" />
        <Footer />
      </section>
      <BackButton />
      <WhatsAppButton />
