...
function saveContact() {
  ...
  a.href = url;
  a.download = "Junaid_Ahamed_Khan_Electi.vcf";
  a.click();
...
export default function CtoPage() {
  ...
  return (
    <>
      <SEOHead
        title="Junaid Ahamed Khan — Co-Founder & CTO | Electi"
        description="Executive Digital Identity — Junaid Ahamed Khan, Co-Founder & CTO at Electi. Building AI systems, automation, and enterprise digital transformation."
        path="/cto"
        noindex
      />
      <div
      ...
      >
        ...
        <div className="relative z-10 flex flex-col lg:flex-row lg:h-screen">
          ...
          <div className="lg:hidden relative w-full overflow-hidden" style={{ height: "72dvh" }}>
            ...
            <img
              src="/junaid-khan.webp"
              alt="Junaid Ahamed Khan — Co-Founder & CTO, Electi"
            ...
            >
              <div style={{ background: "rgba(4,4,4,0.60)", backdropFilter: "blur(28px)", WebkitBackdropFilter: "blur(28px)", borderTop: "1px solid rgba(255,255,255,0.10)", borderRadius: "20px 20px 0 0", padding: "20px 22px 28px" }}>
                ...
                <p className="font-semibold tracking-[0.26em] uppercase text-center mb-0.5" style={{ fontSize: "0.65rem", color: "rgba(255,255,255,0.68)" }}>Co-Founder &amp; CTO</p>
            ...
            >
              <div className="px-5 sm:px-8 py-5">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <span className="text-[9px] tracking-[0.2em] uppercase" style={{ color: "rgba(255,255,255,0.16)" }}>Junaid Ahamed Khan</span>
                </div>
